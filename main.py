...
Target_adj, Exp_Var_adj, CPI_Cs_adj, PPI_Cs_adj = initial_dprocess(
    base_dir, # you should edit this dir
...
num_steps = 12
nn = 6  # Assuming nn is defined as number of variables
...
um4, sm4 = cf_var_doan(Data1, 4, cf_ex1, var_cons1)
um5, sm5 = cf_var_doan(Data1, 4, cf_ex2, var_cons1)
um6, sm6 = cf_var_doan(Data1, 4, cf_ex3, var_cons1)
...
for sheet_name, um in sheet_um_map.items():
    ...
    # Replace columns B:G (i.e., 1 to 6) in the last 12 rows
    df.iloc[-12:, 1:7] = um
